    ...
    public Motor(App a) {
        ...
        canvas.addMouseMotionListener(new MouseMotionListener() {
            ...
            public void mouseDragged(MouseEvent arg0) {
                ((App)jogo).arrasto(arg0.getX(), arg0.getY());
            }
            @Override
            public void mouseMoved(MouseEvent arg0) {
                ((App)jogo).movimento(arg0.getX(), arg0.getY());
            }
        ...
        canvas.addMouseListener(new MouseListener() {
            ...
            public void mousePressed(MouseEvent arg0) {
                ...
                ((App)jogo).aperto(arg0.getX(), arg0.getY());
            }
            @Override
            public void mouseReleased(MouseEvent arg0) {
                if(Math.abs(x - arg0.getX()) < 5 &&
                   Math.abs(y - arg0.getY()) < 5) {
                    ((App)jogo).clique(arg0.getX(), arg0.getY());
                }
                ((App)jogo).solta(arg0.getX(), arg0.getY());
            }
        });
